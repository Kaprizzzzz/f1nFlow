...
export class AboutComponent {
  ...
  private readonly tips: Record<AppLanguage, string[]> = {
    uk: [
      ...
      'Перевіряй вкладку Цілі щодня, щоб бачити темп витрат.',
    ...
    ru: [
      ...
      'Проверяй вкладку Цели ежедневно, чтобы контролировать темп расходов.',
    ...
    es: [
      ...
      'Revisa Metas cada día para mantener el ritmo de gasto bajo control.',
    ...
    be: [
      ...
      'Правярайце ўкладку Мэты штодня, каб кантраляваць тэмп выдаткаў.',
    ...
    fr: [
      ...
      'Ouvrez Objectifs chaque jour pour garder votre rythme de dépenses sous contrôle.',
    ...
    nl: [
      ...
      'Open Doelen elke dag om je uitgaventempo onder controle te houden.',
